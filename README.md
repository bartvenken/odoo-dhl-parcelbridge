...
This branch is for **Odoo 17.0**. Other branches:
...
- Odoo 17.0 (community or enterprise) with `stock_delivery` and `sale`.
...
https://apps.odoo.com/apps/modules/17.0/parcelbridge_dhl_benelux
