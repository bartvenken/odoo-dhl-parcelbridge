...
class StockPicking(models.Model):
    ...
    def action_dhlparcel_export_debug_bundle(self):
        ...
        try:
            bundle["would_send"]["product"] = (
                carrier._dhlparcel_resolve_product(self))
        except Exception as exc:
            bundle["would_send"]["product_error"] = str(exc)
        try:
            bundle["would_send"]["customs"] = (
                carrier._dhlparcel_build_customs(self))
        except Exception as exc:
            bundle["would_send"]["customs_error"] = str(exc)
